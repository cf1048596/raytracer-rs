...
use crate::{color::{write_color, Color}, helper::random_double, interval::Interval, ray::{HitRecord, Hittable, Ray}, vec3::{unit_vector, Point3, Vec3}};
...
impl Camera {
    pub fn new(aspect_ratio: f64, img_width: i32, samples_per_pixel: i32) -> Self {
        Self {
            aspect_ratio,
            img_width,
            img_height: 0,
